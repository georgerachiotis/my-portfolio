...
export const training = [
  { provider: 'Zero To Mastery Academy', courses: ['Complete Web Developer', 'Advanced JavaScript Concepts'] },
  { provider: 'Code With Mosh', courses: ['Ultimate Java Part 1: Fundamentals', 'Ultimate Java Part 2: Object-Oriented Programming', 'Ultimate Java Part 3: Advanced Topics', 'Spring Boot: Mastering the Fundamentals'] },
  { provider: 'freeCodeCamp', courses: ['JavaScript', 'Responsive Web Design', 'Relational Database', 'Scientific Computing with Python'] },
];
